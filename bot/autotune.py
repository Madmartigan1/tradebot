...
CLAMPS_BY_REGIME: Dict[str, Dict[str, Tuple[Optional[float], Optional[float]]]] = {
    "choppy": {"confirm_candles":(2,5), "per_product_cooldown_s":(300,1800), "rsi_buy_max":(60,70),
               "rsi_sell_min":(30,40), "macd_buy_min":(1.0,3.0), "macd_sell_max":(-3.0,-1.0), "ema_deadband_bps":(5.0,8.0)},
    "uptrend": {"confirm_candles":(1,3), "per_product_cooldown_s":(300,1200), "rsi_buy_max":(65,75),
                "rsi_sell_min":(35,45), "macd_buy_min":(1.0,3.0), "macd_sell_max":(-3.0,-1.0), "ema_deadband_bps":(4.5,8.0)},
    "downtrend": {"confirm_candles":(1,3), "per_product_cooldown_s":(300,1200), "rsi_buy_max":(55,65),
                  "rsi_sell_min":(25,40), "macd_buy_min":(2.0,4.0), "macd_sell_max":(-2.5,-1.0), "ema_deadband_bps":(4.5,8.0)},
}
